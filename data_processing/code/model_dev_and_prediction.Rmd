...
Metric = c("Source", 
            ...
            "Farmer-Buyer Links", 
                 "With cooperatives", 
                 "With other buyers", 
            "Share of cooperative outlet in volumes sold", 
            "Average farmer-cooperative Eucl. distance (km)",
            "Buyers", 
                 "Cooperatives", 
                 "Other buyers"
           ),
...
table <- summary_data %>%
  ...
  row_spec(7, extra_css = "padding-left: 10px;") %>%
  row_spec(8, extra_css = "padding-left: 10px;") %>%
  row_spec(11, extra_css = "padding-left: 10px;") %>%
...
lm = train(form = stg1_formula_allfeatures, 
...
```{r}
# Read caret model 
model1_rfe = readRDS(here("temp_data", "model", "caret", "stage_1", "allfeatures_ranger_LOOCV_15tuneL_sizeseveryten_repeatedcv5x5"))
