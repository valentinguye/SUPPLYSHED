...
Metric = c("Source", 
  ...
  KIT = c(
          "Bymolt et al. 2018", "2017", "Village point", "Yes",
  ...
  CARGILL = c(
          "Online repository", "2019", "Farm polygon", "No",
          "Unknown", 
...
model1_rfe <- 
  rfe(form = stg1_formula_allfeatures, 
        ...
        importance="permutation", 
        tuneLength=5,
        sizes = c(5, 10, 50, 90), # tell caret how many different feature subset sizes to try
...
saveRDS(model1_rfe, 
        file = here("temp_data", "model", "caret", "stage_1", "allfeatures_ranger_100boot632_5tuneL_sizes5-10-50-90_repeatedcv5x5"))
...
```{r}
# Read caret model 
model1_caret_rf100 = readRDS(here("temp_data", "model", "caret", "stage_1", "allfeatures_rf_100boot632_5tuneL"))
...
all_or_used_features = model1@required_features #stg1_allfeatures # 
