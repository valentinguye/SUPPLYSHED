...
camcy %>% filter(YEAR == 2019) %>% pull(TOTAL_FARMERS) %>% sum(na.rm = TRUE)
camcy %>% filter(YEAR == 2019) %>% pull(TOTAL_FARMERS) %>% summary()

camcy %>% filter(YEAR == 2020) %>% pull(TOTAL_FARMERS) %>% sum(na.rm = TRUE)
camcy %>% filter(YEAR == 2020) %>% pull(TOTAL_FARMERS) %>% summary()

camcy %>% filter(YEAR == 2021) %>% pull(TOTAL_FARMERS) %>% sum(na.rm = TRUE)
camcy %>% filter(YEAR == 2021) %>% pull(TOTAL_FARMERS) %>% summary()
...
camcy %>% filter(YEAR == 2021) %>% pull(TOTAL_FARMERS_RFA) %>% sum(na.rm = T)
